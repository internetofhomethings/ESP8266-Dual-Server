...
/**
  ...
  * @param  *pPara: Sensor number
  * @retval None
  */
void ICACHE_FLASH_ATTR
at_exeGetSensorVal(uint8_t id, char *pPara)
{
	int isensno = atoi(++pPara);
	switch(isensno) {
		case 1:
			uart0_sendStr(tInside);
			break;
		case 2:
			uart0_sendStr(tOutside);
			break;
		case 3:
			uart0_sendStr(tAttic);
			break;
		case 4:
			uart0_sendStr(tDht11);
			break;
		case 5:
			uart0_sendStr(hDht11);
			break;
		case 6:
			uart0_sendStr(pBmp085);
			break;
		case 7:
			uart0_sendStr(tBmp085);
			break;
		case 8:
			uart0_sendStr(aBmp085);
			break;
		default:
